...
workflow {
    ...
    //something like this
    haplotype_caller( samtools_post_process.out[0] , samtools_post_process.out[1], params.intervals, params.ref_fasta, index_reference.out, create_seq_dict.out ) | 
     */
